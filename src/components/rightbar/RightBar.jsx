        ...
        <div className="item">
          ...
          <div className="user">
            <div className="userInfo">
              <img src="https://images.unsplash.com/photo-1522307837370-cc113a36b784?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHByb2ZpbGUlMjBwaWN0dXJlc3xlbnwwfHwwfHx8MA%3D%3D" alt="" />
              <span>Jane doe</span>
            </div>
            <div className="buttons">
              <button className='follow'>follow</button>
              <button className='dismiss'>dismis</button>
            </div>
          </div>
